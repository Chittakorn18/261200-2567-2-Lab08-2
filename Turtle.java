...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        Thread t1 = new Thread(new TurtleThread(1));
        Thread t2 = new Thread(new TurtleThread(2));
        Thread t3 = new Thread(new TurtleThread(3));
    ...
    static class TurtleThread extends  Thread {
        ...
        public void bob() {
            turtle.speed(0.1);
            turtle.bgcolor("skyblue");  // พื้นหลังสีฟ้า
            turtle.penColor("yellow");  // สีของดวงอาทิตย์
            turtle.up();
            turtle.setPosition(0, 0);   // ตั้งดวงอาทิตย์ให้อยู่ตรงกลาง
            turtle.down();
        ...
        public void drawSun(Turtle turtle, int radius) {
            int steps = 36;
        ...
        public void fah() {
            ...
            for (int i = 0; i < 5; i++) {
                double startX = -200 + i * 100;
                double startY = 100 + (i % 2) * 20;
        ...
        public void drawBird(Turtle turtle) {
            turtle.forward(20);
            turtle.right(45);
            turtle.forward(20);
            turtle.backward(20);
        ...
        public void star() {
            ...
            for (int j = 0; j < 4; j++) {
                turtle.up();
                turtle.setPosition((int)(Math.random() * 400 - 200), (int)(Math.random() * 400 - 200));
                turtle.down();
